...
* インタ＝ネットに接続できない環境でも、**[オフライン版](#data-used)** を使用できるようにする
...
* 例題で使用されている [サンプルデータ](#data-used) を使用すると、本書の内容を実践しながら学ぶことができます。  
...
運営面では、EPIET 同窓生の会（EPIET Alumni Network; [EAN](https://epietalumni.net/)）、とりわけ Annika Wendland から多大なる支援を受け、ここに謝意を示します。EPIET とは、European Programme for Intervention Epidemiology Training（介入疫学トレーニングのための欧州プログラム）の略称です。   
