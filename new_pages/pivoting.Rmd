...
しかし、疫学者が扱う仕事の領域では、非専門家によって作成され、独特で標準的ではない論理に従ったデータを扱う場合が多くあります。Hadley Wickham は、**Tidy Data** の原則に関する彼の[重要な論文](https://vita.had.co.nz/papers/tidy-data.pdf)（Tolstoy と呼ばれる）で次のように指摘しています。「整然データセットは家族のように、どれも似ているが、乱雑なデータセットは乱雑のあり方がそれぞれ異なっている。」
