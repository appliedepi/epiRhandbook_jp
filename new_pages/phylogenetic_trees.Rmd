...
pacman::p_load(BiocManager) # install BiocManager

BiocManager::install("ggtree", update = TRUE, ask = FALSE) # install ggtree

pacman::p_load(here, ggplot2, dplyr, ape, treeio, ggnewscale)
