...
[for ループ]{.ul}は R ではあまり一般的ではないですが、他のプログラミング言語では頻繁に使用されています。初心者の場合、特に自分で関数を書くことに慣れていない場合は、反復処理ごとに何が起こっているのかを正確に把握し、「探索」したり「デバッグ」を行ったりすることが容易になるので、学習や練習に便利です。
