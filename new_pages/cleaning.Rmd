...
<u>(日付データと **lubridat**e パッケージを使用した処理については、日付データの章の [Working with dates](https://epirhandbook.com/en/working-with-dates.html#working-with-dates-1)のページを参照してください。）</u>
